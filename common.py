...
stock_all = {  # 股票数据
        ...
        "600438": {"name": "通威股份", "type": e_pe, "low": 7.5, "high": h_value},
        ...
        "300896": {"name": "爱美客", "type": e_pe, "low": 30, "high": h_value},
        ...
        "002460": {"name": "赣锋锂业", "type": e_pe, "low": 8, "high": h_value},
        ...
        "300144": {"name": "宋城演艺", "type": e_value, "low": 300*unit, "high": h_value},
